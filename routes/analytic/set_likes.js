...
module.exports = function (app) {
    ...
    app.put(`/${endpoint_category}/set_likes`, async (request, response) => {
            ...
            if (!functions.empty(videoExists)) {
                ...
                if (!functions.empty(userExists)) {
                    ...
                    try {
                        ...
                        response.status(200).json({ "status": 200, "message": "Video like stats has been set successfully.", "data": payload });
