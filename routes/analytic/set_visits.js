...
module.exports = function (app) {
    ...
    app.put(`/${endpoint_category}/set_visits`, async (request, response) => {
            ...
            if (!functions.empty(videoExists)) {
                ...
                if (!functions.empty(userExists)) {
                    ...
                    try {
                        ...
                        response.status(200).json({ "status": 200, "message": "Video visit stats has been set successfully.", "data": payload });
