        ...
        try {  
            ...
            if (request.query.token && request.query.workspace_id) {
                ...
                if (!functions.empty(userExists)) {
                    ...
                    let redirect_url = `https://account.box.com/api/oauth2/authorize?client_id=${process.env.BOX_CLIENT_ID}&scope=root_readwrite&response_type=code&redirect_uri=${REDIRECT_URL}&state=${`${request.query.token}_SEPARATOR_${request.query.workspace_id}`}`;
